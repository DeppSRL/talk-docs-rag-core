"""Il contratto di `talkdocs-rag-core`: nucleo importabile senza strato applicativo.
...
def test_import_non_trascina_fastapi():
    ...
    # import mirati
    from talkdocs_rag_core.retrieval.services.embeddings import EmbeddingService  # noqa: F401
    from talkdocs_rag_core.retrieval.services.hybrid_search import HybridSearchService  # noqa: F401
    from talkdocs_rag_core.retrieval.services.llm_generation import LLMGenerationService  # noqa: F401
    from talkdocs_rag_core.retrieval.services.mistral_client import create_mistral_client  # noqa: F401
    from talkdocs_rag_core.retrieval.vector_stores.chroma import ChromaVectorStore  # noqa: F401
...
def test_import_non_legge_env(monkeypatch):
    ...
    for mod in (
        "talkdocs_rag_core.retrieval.services.embeddings",
        "talkdocs_rag_core.retrieval.services.mistral_client",
        "talkdocs_rag_core.retrieval.services.llm_generation",
        "talkdocs_rag_core.retrieval.vector_stores.chroma",
        "talkdocs_rag_core.retrieval.services.hybrid_search",
    ):
...
def test_models_importabili():
    from talkdocs_rag_core.retrieval.models.document import Document, DocumentChunk, SearchResult  # noqa: F401
